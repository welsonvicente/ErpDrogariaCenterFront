...
import { AjustarEnquadramentoModal } from '../components/AjustarEnquadramentoModal';
 ...
 * nativa (ver PLANO-REESCRITA-FERRAMENTAS.md). Os modos Panfleto e Importar
 * planilha ainda não foram portados; o link no rodapé leva pra versão
